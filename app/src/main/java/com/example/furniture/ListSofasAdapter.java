...
public class ListSofasAdapter extends RecyclerView.Adapter {
    ...
    public int getItemCount() {
        return listItems.imgSofasTabLayout.length;
    }
    ...
    private class ListViewBarangHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindView(int position){
            tombolGambar.setImageResource(listItems.imgSofasTabLayout[position]);
            Nama.setText(listItems.NamaSofa[position]);
            Harga.setText(listItems.hargaSofa[position]);
        }
